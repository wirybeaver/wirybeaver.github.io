---
layout:     post
title:      Cracking Rust's Reference
excerpt:    Consolidate the obscured tricks of Rust's Reference, including but not limited to, slice, reborrow, deref coercion and pattern
author:     "Shane"
...
Although there are many Rust tutorials available, I have yet to come across any material that clearly and organically presents the various syntax and underlying mechanisms of Rust's *reference*. Therefore, I wrote this article to document the pitfalls I’ve encountered and the insights I’ve gained. The source code can find in my [gist](https://gist.github.com/wirybeaver/6c87948e4131e25cab1fd8e26addae31).
...
|-------------------------------|------------------------|--------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|
| Immutable reference           | Mutable referent       | Valid        | The value of the referent cannot be modified until the reference's lifetime expires.                                                                  |
| Mutable reference             | Immutable referent     | Invalid      |                                                                                                                                                       |
| Immutable reference           | Immutable referent     | Valid        | The referent can be read by multiple shared references.                                                                                               |
...
The immutable/mutable reference and the mutability of reference itself are totally orthogonal. 
```rust
